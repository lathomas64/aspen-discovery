	...
	<div id="main-content" class="col-sm-12">
		...
		<div class="row">
			...
			{if !empty($priority1Ticket)}
				...
				<div class="col-xs-2">
					<a href="{$rtBaseUrl}/Ticket/Display.html?id={$priority1Ticket->ticketId}" class="btn btn-default btn-sm" aria-label="Open in RT for Ticket {$priority1Ticket->ticketId} (opens in a new window)" target="_blank" ><i class="fas fa-external-link-alt" role="presentation"></i>  Open in RT</a>
				</div>
			{else}
				<div class="col-md-9 result-value">
					N/A
		...
		<div class="row">
			...
			{if !empty($priority2Ticket)}
				...
				<div class="col-xs-2">
					<a href="{$rtBaseUrl}/Ticket/Display.html?id={$priority2Ticket->ticketId}" class="btn btn-default btn-sm" aria-label="Open in RT for Ticket {$priority2Ticket->ticketId}" target="_blank"><i class="fas fa-external-link-alt" role="presentation"></i>  Open in RT</a>
				</div>
			{else}
				<div class="col-md-9 result-value">
					N/A
		...
		<div class="row">
			...
			{if !empty($priority3Ticket)}
				...
				<div class="col-xs-2">
					<a href="{$rtBaseUrl}/Ticket/Display.html?id={$priority3Ticket->ticketId}" class="btn btn-default btn-sm" aria-label="Open in RT for Ticket {$priority3Ticket->ticketId}" target="_blank"><i class="fas fa-external-link-alt" role="presentation"></i>  Open in RT</a>
				</div>
			{else}
				<div class="col-md-9 result-value">
					N/A
					...
					<div class="panel-body">
						{foreach from=$openSupportTickets item=ticket}
							<div class="row striped-{cycle values="odd,even"}">
								...
								<div class="col-xs-2">
									<a href="{$rtBaseUrl}/Ticket/Display.html?id={$ticket->ticketId}" class="btn btn-default btn-sm" aria-label="Open in RT for Ticket {$ticket->ticketId}" target="_blank"><i class="fas fa-external-link-alt" role="presentation"></i>  Open in RT</a>
								</div>
							</div>
						{/foreach}
					</div>
